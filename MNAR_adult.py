...
def load_preproc_data_adult(protected_attributes=None):
    def custom_preprocessing(df):
        ...
        for i in df1['tmp_feature'].unique():
            if i[0] == '0' and '>12' in i:
                df1.loc[df1['tmp_feature'] == i, 'mis_prob'] = 0.65
            elif "=8" in i and i[0] == '1':
                df1.loc[df1['tmp_feature'] == i, 'mis_prob'] = 0.15
            else:
                df1.loc[df1['tmp_feature'] == i, 'mis_prob'] = 0.1
        new_label = []
...
#         new_label =[]
#         for i,j in zip(df['Education Years'],df['sex']):
#             if j == 0 and i =='>12':
#                 if np.random.binomial(1, 0.95, 1)[0]==1:
#                     new_label.append(-1)
#                 else:
#                     new_label.append(i)
#             elif j ==0:
...
#                     new_label.append(i)
#             else:
#                 if np.random.binomial(1, 0.08, 1)[0]==1:
#                     new_label.append(-1)
#                 else:
#                     new_label.append(i)
