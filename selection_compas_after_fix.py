...
class CompasDataset_train(StandardDataset):
    ...
    def __init__(
        ...
        _, df_neg_unpriv_test = train_test_split(
            df_neg_unpriv, test_size=920, random_state=10)
        df_neg_test = df_neg_priv_test.append(df_neg_unpriv_test)
#         _,df_neg_test = train_test_split(df_neg,test_size=1800,random_state= 8)
        ...
        _, df_pos_priv_test = train_test_split(
            df_pos_priv, test_size=680, random_state=10)
        _, df_pos_unpriv_test = train_test_split(
            df_pos_unpriv, test_size=900, random_state=10)
#         _,df_pos_test = train_test_split(df_pos,test_size=1000,random_state= 8)
